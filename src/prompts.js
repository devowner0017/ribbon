...
export const PROMPT_FOUR = (draft) => {
    return `Now give me 3 versions of the email "${draft}" varying by tone, length and level of detail. In the end of each version, insert $ symbol. And Don't remove the subject.`;
}